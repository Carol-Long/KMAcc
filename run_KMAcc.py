...
def run_for_task(features, labels, base_classifiers, prefix):
  ...
  for classifier in base_classifiers:
    base_msce, base_KME, kMAcc_msce, kMAcc_KME, LSBoost_msce, LSBoost_KME, MCBoost_msce, MCBoost_KME, \
    base_iso_msce, base_iso_KME, kMacc_iso_msce, kMAcc_iso_KME, MCBoost_iso_msce, MCBoost_iso_KME, AUC = achieving_calibration_with_witness(features, labels, classifier)

    data_class.append((base_msce, base_KME, kMAcc_msce, kMAcc_KME, LSBoost_msce, LSBoost_KME, MCBoost_msce, MCBoost_KME, \
    base_iso_msce, base_iso_KME, kMacc_iso_msce, kMAcc_iso_KME, MCBoost_iso_msce, MCBoost_iso_KME, AUC))
